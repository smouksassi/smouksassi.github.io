...
When the COVID-19 pandemic started, there were several live dashboards floating around and I wanted to challenge my dashboarding/R Shiny skills building my own. A gif animation of how this dashboard looked like in 2020 is shown below. It had interactive filters, a map with a 3D/2D projection. Cross-filtering between widgets and sparklines. The repo lives [here](https://github.com/smouksassi/covid19dashboard) but note that some links to publicly available databases at the time might be broken.

![](dashboard.gif)

This how I produced the `plotly` 3D gobe using the last data snapshot I could find on github:
...
Have a look at the dashboard source code if you want to see how cross filtering and interactivity were handled. Another nice feature was the table that had sparklines and reproduced below:
