...
$$CL = \color{blue}{POPCL} \times \left( \frac { \color{green}{Weight}} {70}\right)^\color{blue}{dWTdCL}\times \left( \frac { \color{green}{Age}} {\color{green}{Age} + \color{blue}{Age50}}\right)\times exp(\color{red}\eta\color{red}{CL})$$
...
$$log(CL) = \color{blue}{3.7421} + \color{blue}{1.0078}\times\left( \frac { \color{green}{wt}} {70}\right)+log\left(\color{green}{age}/(\color{green}{age}+4.8422)\right)$$
