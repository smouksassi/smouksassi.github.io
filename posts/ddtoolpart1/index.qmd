...
And now I can use `computerelativeHR` to compute the HR for any set of ref to test values and this what powered the paper R Shiny app: [Online Interactive Hazard Ratio Calculator](https://pharmacometrics.shinyapps.io/KIreports/)
